...
# samtools filter unique and sort in one line
samtools view -bq 1 ../../bam/L316_Track-326_R1.fastq.sam.bam | samtools sort -o - deleteme > L316_Track-326_R1.fastq.sam.bam.sorted
...
# extending reads
perl ~/src/chIPbedExtender.pl /biodata/biodb/ABG/genomes/mouse/mm9/mm9.fa.fai wanted.bed 200
