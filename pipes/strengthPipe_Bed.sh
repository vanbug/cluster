#!/bin/bash
# true coverage pipeline bed(6/12) -> bw
#samtools sort L317_Track-327_R1.fastq.sam.bam.unique L317_Track-327_R1.fastq.sam.bam.unique.sorted &
file=$1

awk '$6=="+"' $1 | genomeCoverageBed -i stdin -bg -g ~/src/useFul/ucsc/genomeIndex/mm9.chrom > plus.bg
awk '$6=="-"' $1 | genomeCoverageBed -i stdin -bg -g ~/src/useFul/ucsc/genomeIndex/mm9.chrom > minus.bg
