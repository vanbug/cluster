...
#USAGE : qsub pBWA_sai2sam.sh a.sai a.fq YOYO
######################################################################
...
/opt/openmpi/bin/mpirun -np 20 --mca btl_tcp_if_include eth0 pBWA samse -f $file.sam /biodata/biodb/ABG/genomes/mouse/mm9/mm9 $1 $2
